...
namespace Payroll_APP_API.Controllers
{
    ...
    public class PayrollAPI : ControllerBase
	{
		...
		public  ArrayList AddEmployee() {
			...
			string form_salary = Request.Form["basic_salary"];//basic salary coming in request isisi kjdlkdjlkdjlk
			string emp_type = Request.Form["emp_type"];// type of employee coming in request jdjjjdjdj
